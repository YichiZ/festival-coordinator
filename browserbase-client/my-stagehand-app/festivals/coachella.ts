...
const coachella: FestivalConfig = {
  name: "coachella-2026",
  url: "https://www.coachella.com/lineup",
  agentSystemPrompt:
    "You are a data extraction assistant. Your goal is to scrape the complete Coachella 2026 lineup from this page. Navigate through ALL available days and stages. Click on each day tab, expand any filters or sections, and ensure you see every artist. After you have navigated through everything and have a comprehensive view, report done.",
  agentInstruction:
    "Navigate the Coachella 2026 lineup page. Click through each day (Friday, Saturday, Sunday) and each stage to ensure all artists are loaded. Scroll down to see all artists. Once you have explored all days and stages, report what you found: list every artist with their stage, date, and set time.",
  extractInstruction:
